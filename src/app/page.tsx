  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-gradient-to-b from-white via-white to-muted/60">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        {/* Conic ring accent */}
        <div className="absolute inset-0 opacity-50 blur-lg [mask-image:radial-gradient(circle_at_center,white,transparent_65%)] [background:conic-gradient(from_180deg_at_50%_50%,rgba(0,0,0,0.12),transparent_30%,rgba(0,0,0,0.12)_60%,transparent_90%)]" />
        {/* Diagonal stripes */}
        <div className="absolute inset-0 opacity-20 mix-blend-multiply [mask-image:radial-gradient(ellipse_at_center,white,transparent_70%)] [background-image:repeating-linear-gradient(45deg,rgba(0,0,0,0.06)_0px,rgba(0,0,0,0.06)_2px,transparent_2px,transparent_12px)]" />
        {/* Soft glows */}
        ...
        <div className="absolute top-1/3 -right-24 h-[22rem] w-[22rem] rounded-full bg-gradient-to-br from-primary/10 to-foreground/5 blur-3xl" />
        <div className="absolute bottom-10 left-1/4 h-72 w-72 rounded-full bg-gradient-to-tr from-foreground/10 to-primary/5 blur-3xl" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 h-[34rem] w-[34rem] rounded-full bg-gradient-to-b from-primary/5 to-transparent blur-[100px] opacity-70" />
      </div>
      <Header />
      <HeroSection />
      <ExecutiveSearch />
